...
def createwidgets():
    ...
    root.UpButton = Button(root, width=10, text="UP", command=led_on)
    root.UpButton.grid(row=5, column=6, padx=10, pady=10)

    root.DownButton = Button(root, width=10, text="DOWN", command=led_off)
    root.DownButton.grid(row=6, column=6, padx=10, pady=10)

    root.LeftButton = Button(root, width=10, text="LEFT", command=led_on)
    root.LeftButton.grid(row=6, column=5, padx=10, pady=10)

    root.RightButton = Button(root, width=10, text="RIGHT", command=led_off)
    root.RightButton.grid(row=6, column=7, padx=10, pady=10)
